...
public class TSValue {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(value, tsValue.value) &&
                Objects.equals(atom, tsValue.atom); // Include atom type in equality
    }

    @Override
    public int hashCode() {
        return Objects.hash(value, atom); // Include atom type in hash calculation
    }
