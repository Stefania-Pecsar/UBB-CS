...
crtDir =  os.getcwd()
filePath = os.path.join(crtDir, 'data', 'D:/lab5/v1_world-happiness-report-2017.csv')
...
error = mean_squared_error(validationOutputs, computedValidationOutputs)
print('prediction error (tool):  ', error)
print("Family nu influenteaza Happyness-ul deci nu e tocmai relevant sa facem vreo modificare")
...
print("Fara normalizare:")
print("prediction error (tool):  0.28494704427651035")
print("prediction error (tool):   0.28494704427651035")