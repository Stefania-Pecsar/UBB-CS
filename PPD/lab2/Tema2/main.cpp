...
void readValues() {
    std::ifstream in("C:/Users/Administrator/Fac/AN 3/PPD/Tema2java/src/data/date.txt");
...
int main() {
    ...
    std::ofstream out("C:/Users/Administrator/Fac/AN 3/PPD/Tema2java/src/data/output.txt");
