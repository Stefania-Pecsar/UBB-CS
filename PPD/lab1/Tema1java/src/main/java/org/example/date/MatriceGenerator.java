...
public class MatriceGenerator {
    ...
    public static void saveMatrixAndFilterToFile(int[][] matrix, int[][] filter, String filename) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filename))) {
            ...
            System.out.println("Matricea si filtrul au fost salvate in " + filename);
        } catch (IOException e) {
    ...
    public static void main(String[] args) {
        ...
        String filename = "C:\\Users\\Administrator\\Fac\\AN 3\\PPD\\Tema1java\\src\\main\\java\\org\\example\\date\\date.txt";
